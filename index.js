...
wordList = ["LUKE", "ANAKIN", "DARTH VADER", "OBI WAN KENOBI", "HAN SOLO", "CHEWBACCA", "PADME", "YODA", "BOBA FETT", "JAR JAR BINKS", "R2-D2", "MACE WINDU", "DARTH MAUL", "C-3PO"];
var select = 0;
var chosenWord = "";
var gameWord = "";
var counter = 0;
...
function startGame() {
    ...
    console.log("\nYou have 8 letter guesses to find the Star Wars character.\n".cyan)
    promptUser();
}
